// Minimal inline SVG icon set (stroke style, like Lucide) — no extra deps.
...
export const ScaleIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <path d="M5 7h14l-2.5 5a3.5 3.5 0 0 1-6.4 0L5 7Z" />
    <path d="M12 3c-1 0-1.5.5-2 1.5L5 7h14l-5-2.5C13.5 3.5 13 3 12 3Z" />
  </svg>
);
...
export const FlameIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M12 2s5 4.5 5 10a5 5 0 0 1-10 0c0-2 .8-3.8 2-5.5 0 1.5.6 2.5 1.5 3C10 7 11 4.5 12 2Z" />
  </svg>
);
...
export const RestaurantIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M6 2v6a2 2 0 0 0 4 0V2M8 2v20M17 2c-2 1.5-3 4-3 7 0 2 1 3.5 3 4v9" />
  </svg>
);
